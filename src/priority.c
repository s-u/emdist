...
void ILLutil_priority_findmin (ILLpriority *pri, double *keyval, void **en)
{
    int handle;
...
int ILLutil_priority_insert (ILLpriority *pri, void *data, double keyval,
        int *handle)
{
    int newsize;
    int i;
...
void ILLutil_priority_deletemin (ILLpriority *pri, double *keyval, void **en)
{
    int handle;
    void *data;
...
void ILLutil_priority_changekey (ILLpriority *pri, int handle, double newkey)
{
